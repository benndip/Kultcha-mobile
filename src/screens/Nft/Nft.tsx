  ...
  const Nft = ({ navigation }) => {
    ...
    return (
      <View className="pt-14">
        ...
        <ScrollView>
          <Image
            source={require("../../assets/images/nftBox.png")}
            style={{ width: 220, height: 228, alignSelf: "center" }}
          />
          <Text className="self-center text-xl font-bold">
            Make your art an NFT
          </Text>
          <Text className="self-center text-sm font-light mb-10">
            Have it on OpenSea
          </Text>
          <Dropdown
          ...
          <TextInput
            ...
            placeholder="Description the art telling us what makes it special"
            numberOfLines={6}
          />
          <TextInput style={styles.input} placeholder="Base Price" />
          <View
            style={{
              flexDirection: "row",
              alignItems: "center",
          ...
          <Text className="mt-10 w-[80%] self-center">
            By clicking “Post” i agree with all{" "}
            <Text className="text-[#500BFF]">Terms</Text> and{" "}
            <Text className="text-[#500BFF]">Conditions</Text> of Kultcha
          </Text>
